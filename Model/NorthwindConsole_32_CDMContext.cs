...
{
    public partial class NorthwindConsole_32_CDMContext : DbContext
    {
        public NorthwindConsole_32_CDMContext()
        {
        }

        public NorthwindConsole_32_CDMContext(DbContextOptions<NorthwindConsole_32_CDMContext> options)
            : base(options)
        {
        }
